...
Client client = Client()
    ...
    .setProject('66af4a6b0001d0f2a67a')
    .setSelfSigned(
        status: true); // For self signed certificates, only use for development

const String db = "66af4bfa001ad6e6cfee";
const String userCollection = "66af4c0c001f113e2aca";
const String chatCollection = "66b064700029fb6e9f0a";
const String storageBucket = "66af522f00023c3e3344";
